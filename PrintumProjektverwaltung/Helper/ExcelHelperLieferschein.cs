...
namespace PrintumProjektverwaltung.Helper
{
    class ExcelHelperLieferschein
    {
        ...
        private static string vorlageFileBlanko = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\Lieferschein_Blanko-Template.xlsx";
        private static string vorlageFileUnterschrift = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\Lieferschein_Unterschrift-Template.xlsx";
        private static string vorlageFileLKW = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\Lieferschein_LKW-Template.xlsx";
        // Englische Templates
        private static string vorlageFileBlankoEN = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\DeliveryNote_Blanko-Template.xlsx";
        private static string vorlageFileUnterschriftEN = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\DeliveryNote_Unterschrift-Template.xlsx";
        private static string vorlageFileLKWEN = @"\\printumserver.print.local\PT-99-Vorl\Dokumente\DeliveryNote_LKW-Template.xlsx";
